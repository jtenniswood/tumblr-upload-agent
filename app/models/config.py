...
class ImageAnalysisConfig(BaseSettings):
    ...
    gemini_prompt: str = Field(
        ...
        "Do not state 'Here is a description of the image'. Do not start with 'The image showcases' or 'The image depicts' Simply describe the images content without preamble..",
        env="GEMINI_PROMPT"
    )
